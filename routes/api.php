...
Route::get('experiences', [App\Http\Controllers\ExperiencesController::class, 'index']);
Route::get('experiences/filter', [App\Http\Controllers\ExperiencesController::class, 'filter']);
